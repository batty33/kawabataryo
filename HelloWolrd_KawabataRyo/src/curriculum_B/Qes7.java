...
public class Qes7 {
	...
	public static void main(String[] args) {
		...
		do {
			...
			// studentsNumに入力された数字を代入
			studentsNum = scanner.nextInt();
		// dowhileの条件をstudentsNumが2以上とする	
		} while (studentsNum < 2);
